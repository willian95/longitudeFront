...
<section class="main-services grid-section container-main">
  ...
  <div class="grid grid-main">
    <a href="{{ url('servicio/'.App\Models\Service::find(1)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
    ...
    <a href="{{ url('servicio/'.App\Models\Service::find(2)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
    ...
    <a href="{{ url('servicio/'.App\Models\Service::find(3)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2100">
      <div>
    ...
    {{--<a href="{{ url('servicio/'.App\Models\Service::find(4)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2100">
      <div>
    ...
    <a href="{{ url('servicio/'.App\Models\Service::find(5)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2100">
      <div>
    ...
    <a href="{{ url('servicio/'.App\Models\Service::find(6)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2100">
      <div>
    ...
    <a href="{{ url('servicio/'.App\Models\Service::find(7)->slug) }}" class="item" data-aos="fade-up"
     data-aos-easing="linear"
     data-aos-duration="2100">
      <div>
